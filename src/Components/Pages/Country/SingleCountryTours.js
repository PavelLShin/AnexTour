...
import styles from '../SearchTours/SearchTours.module.css'
import BtnImg from '../btn/img/BtnImg.png'
import Wall from '../SearchTours/img/BCphoto.png'
...
import ToursNotFound from './ToursNotFound'
import FormSearchTours from '../UI/FormSearchTours'

function SingleCountryTours({
  isActive,
  toggleIsActive,
  pointerEv,
  activSort,
  ...
  const [data, setData] = useState(
    datas.filter((tour) => tour.name === params.slug)
  )

  const [returnArr, setReturnArr] = useState([...data])
                  ...
                  <div className={styles.card_container} key={id}>
                    ...
                    <div className={styles.card_container__info}>
                      <div className={styles.card_container__info_head}>
                        ...
                        <div
                          className={styles.card_container__info_head_ocenka}
                        >
                          <div
                            className={
                      ...
                      <div className={styles.card_container__info_bottom}>
                        <div
                          className={styles.card_container__info_bottom_left}
                        >
                          <div
                        ...
                        <div
                          className={styles.card_container__info_bottom_right}
                        >
                    ...
                    <div className={styles.card_container_right}>
                      ...
                      <div className={styles.card_container_right_bottom}>
                        ...
                        <Link
                          to={`../search_tours/${tours.slug}`}
                          className={styles.card_container_right_bottom_link}
                        >
                          <h2 className={styles.main_input_btn_txt}>
                            Подобрать
                          </h2>
                          <img
                            src={BtnImg}
...
export default SingleCountryTours
